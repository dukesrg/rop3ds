...
//	#define POP_R0_1_2_3_4_PC		0x0022B550
	...
	#if defined(SPIDER_4_KR) //1.7538.KR
		#define FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC	0x0019C25C
		#define IFile_Open_LDMFD_SP_R4_5_6_7_8_PC	0x0022F288
	...
	#elif defined(SPIDER_4_TW) //1.7538.TW
		#define FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC	0x0019C264
		#define IFile_Open_LDMFD_SP_R4_5_6_7_8_PC	0x0022F2DC
		#define IFile_Read_LDMFD_SP_R4_5_6_7_8_9_PC	0x00168100
	...
	#endif
#elif defined(SPIDER_5) || defined(SPIDER_5_CN) || defined(SPIDER_5_KR) || defined(SPIDER_5_TW)
	#define CODE_TARGET			0x19592000
...
//	#define POP_R4_5_6_7_8_9_10_11_12_PC	0x0010CC4C
	#if defined(SPIDER_5_CN) //1.7552.CN
		#define FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC	0x0019CA2C
		#define IFile_Open_LDMFD_SP_R4_5_6_7_8_PC	0x0022EA60
		#define IFile_Read_LDMFD_SP_R4_5_6_7_8_9_PC	0x00167520
	...
	#elif defined(SPIDER_5_KR) //1.7552.KR
		#define FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC	0x0019B7D4
		#define IFile_Open_LDMFD_SP_R4_5_6_7_8_PC	0x0022FACC
		#define IFile_Read_LDMFD_SP_R4_5_6_7_8_9_PC	0x00168700
	...
	#elif defined(SPIDER_5_TW) //1.7552.TW
		#define FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC	0x0019CA7C
		#define IFile_Open_LDMFD_SP_R4_5_6_7_8_PC	0x0022FB60
		#define IFile_Read_LDMFD_SP_R4_5_6_7_8_9_PC	0x00168748
...
//		#define ROP_LOC				0x08CF208C
	...
	#endif
#elif defined(SPIDER_9) || defined(SPIDER_9_CN) || defined(SPIDER_9_KR) || defined(SPIDER_9_TW)
	#define CODE_TARGET			0x19592000
	...
	#if defined(SPIDER_9_CN) //1.7567.CN
		#define FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC	0x0019B7E4
		#define IFile_Open_LDMFD_SP_R4_5_6_7_PC	0x0022EA28
		#define IFile_Read_LDMFD_SP_R4_5_6_7_8_9_PC	0x00167544
	...
	#elif defined(SPIDER_9_KR) //1.7567.KR
		#define FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC	0x0019CA84
		#define IFile_Open_LDMFD_SP_R4_5_6_7_8_PC	0x0022FA90
	...
	#elif defined(SPIDER_9_TW) //1.7567.TW
		#define FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC	0x0019CACC
		#define IFile_Open_LDMFD_SP_R4_5_6_7_8_PC	0x0022FB24
		#define IFile_Read_LDMFD_SP_R4_5_6_7_8_9_PC	0x00168764
...
//		#define rop_memcpy(dst, src, size) .word POP_R0_1_2_3_4_PC, dst, src, size, GARBAGE, GARBAGE, POP_R2, POP_PC, POP_R4_LR_BX_R2, GARBAGE, POP_PC, MEMCPY_LDMFD_SP_R4_5_6_7_8_9_10_LR
	...
	#define rop_sleep(ns)			.word POP_R0_PC, ns, POP_R1_PC, 0, POP_LR_PC, POP_PC, SVC_0A_BX_LR 
	#if !(defined(SPIDER_4) || defined(SPIDER_5) || defined(SPIDER_9)) //SPIDER CN,KR,TW
		#define rop_fs_mount(drive)		.word POP_R0_PC, drive, FS_MOUNTSDMC_LDMFD_SP_R3_4_5_PC, GARBAGE, GARBAGE, GARBAGE
		...
		#define rop_flush_data_cache(buffer, size) .word POP_R0_1_2_3_4_7_PC, HANDLE_PTR, KPROCESS_HANDLE, buffer, size, GARBAGE, GARBAGE, GSPGPU_FlushDataCache_LDMFD_SP_R4_5_6_PC, GARBAGE, GARBAGE, GARBAGE
	#else
